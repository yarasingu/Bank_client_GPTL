from ._anvil_designer import star_3_borrower_registration_form_step_1Template
from anvil import *
import anvil.server
...
class star_3_borrower_registration_form_step_1(star_3_borrower_registration_form_step_1Template):
