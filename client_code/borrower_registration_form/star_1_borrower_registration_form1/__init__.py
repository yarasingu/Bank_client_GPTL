from ._anvil_designer import star_1_borrower_registration_form1Template
from anvil import *
import anvil.server
...
class star_1_borrower_registration_form1(star_1_borrower_registration_form1Template):
