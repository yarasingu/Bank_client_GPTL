from ._anvil_designer import star_2_borrower_registration_form_step_2Template
from anvil import *
import anvil.server
...
class star_2_borrower_registration_form_step_2(star_2_borrower_registration_form_step_2Template):
